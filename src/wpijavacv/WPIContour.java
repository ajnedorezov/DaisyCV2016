...
//        memStorage = contours.storage();
    ...
    public synchronized WPIPolygon approxPolygon(double percentAccuracy){
        WPIPolygon polygon = new WPIPolygon(opencv_imgproc.cvApproxPoly(contours, contours.header_size(), contours.storage(), opencv_imgproc.CV_POLY_APPROX_DP, percentAccuracy, 0));
        if (getPool() != null) {
